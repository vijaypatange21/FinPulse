...
const AlertDetail = () => {
    ...
    return (
        <div className="bg-[#f6f6f8] dark:bg-[#101622] font-sans text-slate-900 dark:text-slate-100 min-h-screen flex flex-col">
            ...
            <header className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 sticky top-0 z-50">
                <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="h-8 w-8 rounded-full bg-[#2262ec] flex items-center justify-center text-white font-semibold text-xs">JD</div>
                    </div>
                </div>
            </header>
            ...
            {/* Main Content Area */}
            <main className="max-w-7xl mx-auto px-4 py-8 w-full flex-grow flex flex-col lg:flex-row gap-8 pb-32">
            ...
            <footer className="fixed bottom-0 left-0 right-0 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border-t border-slate-200 dark:border-slate-800 py-4 px-4 z-50 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
                <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <div className="flex flex-wrap justify-center items-center gap-3 w-full sm:w-auto">
                        <button className="px-5 py-2.5 rounded text-sm font-semibold text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
                            Dismiss Alert
                        </button>
                        <button className="px-5 py-2.5 rounded text-sm font-semibold text-[#2262ec] bg-[#2262ec]/10 hover:bg-[#2262ec]/20 transition-colors">
                            Contact Borrower
                        </button>
